    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for(var i=0;i<response.Senderos.length;i++) {
                ...
                {
                    strSQL2 = strSQL2 + "(" + response.Senderos[i].SenderoPuntoElevacion[x].ID + ","+response.Senderos[i].ID+", '"+response.Senderos[i].SenderoPuntoElevacion[x].Latitud+"','"+response.Senderos[i].SenderoPuntoElevacion[x]+"','"+response.Senderos[i].SenderoPuntoElevacion[x].Altura+"'),"
                }
